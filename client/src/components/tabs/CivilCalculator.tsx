/**
 * BidPhase — Tab 1: Civil & Underground (Conduit Calculator)
...
function OutputCard({ icon, label, value, unit, flash }: OutputCardProps) {
  return (
    <div className="bp-card p-4 flex flex-col gap-2">
      ...
      <div
        className={cn("text-3xl font-bold tracking-tight", flash && "num-flash")}
...
export default function CivilCalculator() {
  const { civilState, setCivilState, pushDistanceToCivil } = useApp();
  ...
  const setDistance = (v: number) => setCivilState({ ...civilState, distance: v });
  const setConductors = (v: number) => setCivilState({ ...civilState, conductors: v });
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Conduit run — pipe, couplings, wire
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-lg mx-auto space-y-6">
              ...
              <div className="bp-card p-4 space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  {distance === 0 && (
                    <p className="text-[10px] text-[#F5C518] font-mono">
                      ↑ Type distance or push from the plan on the left
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className="text-xl font-bold text-[#F5C518]"
                      style={{ fontFamily: "'JetBrains Mono', monospace" }}
                    >
                      {conductors}
                    </span>
