...
- [ ] Pull the latest GitHub main branch and inspect migrations 0029, 0030, and 0031
- [ ] Apply the verified pending schema migrations with `pnpm db:push` before release
